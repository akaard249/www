...
$db_string = "select * from users where user_cpr = '$_COOKIE[user_cpr]';";
$user_query = mysqli_query($con,$db_string);
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="pricing__item">
                        <div class="pricing__item__title">
                            ...
                            <h3><?php echo$user_info["user_name"];?> <span><?php echo$user_info["user_company"];?></span></h3>
                        </div>
                        <ul>
                            <li>
                             <span>الرقم الشخصي</span>   
                            <h6><?php echo$user_info["user_cpr"];?></h6>
                                
                            </li>
                            <li>
                                 <span>مقدار المشاركة</span>   
                            <h6><?php echo$user_info["user_share"];?></h6>
                            </li>
                            <li>
                                 <span>رقم البنك المرجعي</span>   
                            <h6><?php echo$user_info["user_br"];?></h6>
                        </li>
                            <li>
                                <span>الرقم الشخصي لأقرب شخص</span>   
                            <h6><?php echo$user_info["user_rel_cpr"];?></h6>
                        </li>
                        </ul>
                        <a href="password.php" class="primary-btn">تعديل كلمة المرور</a>
                    </div>
                </div>
              <div class="col-lg-4 col-md-6 col-sm-6">
                        </div>  
