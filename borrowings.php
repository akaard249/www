...
<head>
	...
	<script src="/api/js/type1_borrowings.js"></script>
	...
	<header class="header">
		...
		<div class="container">
			<div class="row align-items-center " style="">
				...
				<li class='active's><a href='/borrowings.php'>الاستلافات</a></li>
	...
	<section class="consultation">
		<div class="container">
			<div class="row">
				<div class="col-lg-4">
					<div class="consultation__form">
						...
						<div class="br_submit">
							...
							<input type="text" id="user_cpr" value="<?php echo $user_cpr; ?>"
								readonly Hidden>
							<div id="error"></div>
							<button type="submit" id="br_but" class="site-btn" id="">تقديم
								طلب سلفة</button>
						</div>
				...
				<div class="col-lg-8">
					<div class="consultation__text p-t-0 p-b-10">
						<div class="row">
							<div id="report_resize" class="col-lg-6 col-md-6" style="overflow:auto;"> 
								<div class="table table-striped">
									<div class="br_results">
									<table id="br_table" width="100%" class="sortable">
										<thead>
										...
										<tbody id="par_br_result" style="overflow: auto;">
										</tbody>
									</table>
								</div>
							</div>
							</div>
							<div id="details_resize" class="col-lg-6 col-md-6">
