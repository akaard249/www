...
$users_query = "select * from users where user_type = '1' order by user_reg_date desc ";
		...
		<div class="row">
			<div class="col-lg-4">
				<div class="dropdown" style="margin-right:50px;margin-bottom:30px;">
					<a href="add_user.php"> <button class="dropbtn"
							style="background-color:grey;font-size:20px;"> إضافة عميل
						</button></a>
		...
		while($data = mysqli_fetch_assoc($users_result)){
			if( $data["user_status"] == 1){
				echo " <div class='col-lg-4 col-md-6 col-sm-6'>
						<div class='blog__item' style='background-color:rgb(100,255,150);border-raduis:5px;'>
							<div class='blog__item__text'>
								<h5><a href='single_user.php?user_cpr=$data[user_cpr]'>$data[user_name]</a></h5>
								<ul align='center'>
									<li>الشركة : $data[user_company]</li>
						
									<li> تاريخ الإشتراك : $data[user_reg_date]</li>
						
									<li>الدفعة الأولية : $data[user_init_payment]</li>
								</ul>
							</div>
						</div>
					</div>";
				...
				echo " <div class='col-lg-4 col-md-6 col-sm-6'>
						<div class='blog__item' style='background-color:rgb(100,100,100);border-raduis:5px;'>
							<div class='blog__item__text'>
								<h5><a href='single_user.php?user_cpr=$data[user_cpr]'>$data[user_name]</a></h5>
								<ul align='center'>
									<li>الشركة : $data[user_company]</li>
