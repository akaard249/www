...
// payment user select
$users_cpr = "select DISTINCT(users.user_name) , loans.user_cpr from loans inner join users on users.user_cpr = loans.user_cpr where loan_status = '1' and loan_payback_status = '0';";
$users_cpr_query = mysqli_query($con, $users_cpr);

// result user cpr list
$users_cpr_list = "select user_name , user_cpr from users where user_type = '1';";
$users_cpr_list_query = mysqli_query($con, $users_cpr_list);

//result year list 
$share_year = "select min(year(loan_acceptance_date)) year from loans ";
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
  ...
  <script src="/api/js/loan_payback.js"></script>
...
<div class="share_payment">
                           ...
                           <div class="error">
                            ...
                            <div></div>
							 ...
							 <button style="display:none;" name="loan_payback" class="site-btn" id="btn_sub">تسجيل</button>
                          </div>                   
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="share_search">
                            <div class="col-lg-10 col-md-10 col-sm-10">
                                ...
                                <select name="year" id="loans_payments_year">
                                ...
                                <select name="month" id="loans_payments_month">
                                ...
                                <label for="user"> اختر العميل </label> 
                                <select name="user_cpr" id="user_cpr">
                                    <option value="whole">الكل</option>
                                    <?php
                                       while($row = mysqli_fetch_assoc($users_cpr_list_query)){
...
<div class="error">
    ...
    <div class=""></div>
                    ...
                    <div class="table table-responsive" style="height:500px;">
                        <div class="loan_payback_result">
                            <table class="table table-striped" style="overflow-y:scroll;" >
                            <thead >
                                    <th scope="col" style="position: sticky;top: 0px">الرقم الشخصي</th>
                                    <th scope="col" style="position: sticky;top: 0px">اسم العميل</th>
                                    <th scope="col" style="position: sticky;top: 0px">رقم القرض</th>
                                    <th scope="col" style="position: sticky;top: 0px">كمية القرض</th>
                                    <th scope="col" style="position: sticky;top: 0px">كمية الدفعة </th>
                                    <th scope="col" style="position: sticky;top: 0px">تاريخ الدفعة</th>
                            </thead>
                            <tbody  style="" id="loans_table_result">
                     ...
                     <div class="col-lg-4 col-md-8">
                        <div class="footer__newslatter">
                            <form action="#" dir="ltr">
                                ...
                                <button style="font-size:15px" class="site-btn">تواصل معنا </button>
                            </form>
                        </div>
                    </div>
