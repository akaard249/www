...
<head>
	...
	<script src="/api/js/add_user.js"></script>
</head>
...
<body>
	...
	<section class="breadcrumb-option spad set-bg"
		style="background:url('../img/banner.avif');background-style:stretch;">
		<div class="container">
			<div class="row">
	...
	<div class="row">
		<div class="add_user_form">
				...
				<input type="text" id="user_cpr" name="user_cpr" maxlength="9" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');"
				 placeholder="الرقم الشخصي" required>
				...
				<input type="text" 
					...
					id="user_init_payment" name="user_init_payment" placeholder="الدفعة الأولية"
					required>

				<select id="user_reg_year" >
					<i> سنة التسجيل	</i>
					<option value="<?php echo date('Y');?>">السنة الحالية</option>
					<?php 
				...
				<input type="text" id="user_init_share" placeholder="الدفعات الشهرية الأولية" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');">

				
				<input type="text"  maxlength="10" 
					oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');"
					id="user_phone" placeholder="رقم الهاتف"
					required>
				<input type="text" id="user_rel" placeholder="اسم اقرب شخص للعميل "
					required>
				<input type="text"  maxlength="9" id="user_rel_phone" placeholder="رقم الهاتف لاقرب شخص للعميل "
...
<div></div>
				...
				<button id="add_user_submit_button" name="add_user" >إضافة العميل</button>
