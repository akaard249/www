...
elseif($user_type == 3){
$pending_requests = "select loans.loan_id ,users.user_name , user_company , loans.loan_amount , loans.loan_status , loans.loan_submition_date from loans inner join users where users.user_cpr = loans.user_cpr and loans.loan_status = '3';";
...
<body>
						...
						<nav class="header__menu">
							...
							if($user_type == 1 ){
								...
								";
									...
									echo "
                                <li ><a href='/management'>الرئيسية</a></li>
	...
	<div class="content">
		...
		<div class="container">
			<div class="tab">
				<button class="tablinks active" onclick="toggle(event, 'pending')"> القروض المعلقة</button>
				<button class="tablinks" onclick="toggle(event, 'accepted')">القروض الممنوحة</button>
				<button class="tablinks" onclick="toggle(event, 'rejected')">القروض المرفوضة</button>
			</div>
					...
					<table class="table table-striped custom-table">
						<thead>
							<tr style="color:black;">
								...
								<th scope="col">كمية القرض</th>
								<th scope="col">تاريخ طلب القرض</th>
                      ...
                      <td><a href='review?request_id=$table[loan_id]'>$table[user_company]</a>
                      ...
                      <td>$table[loan_submition_date]</td>
					  
                     
					  
                      <td><a href='review?request_id=$table[loan_id]' class='more'>معالجة</a></td>
