...
<div class="services__appoinment" style="margin-right:15%;margin-left:15%;margin-top:30px;margin-bottom:30px;">
						<div class="services__title">
							<h4> إضافة عميل</h4>
						</div>
					<div class="form">
					<form action="api/api.php" method="post">
							<input type="text" id="user_cpr" name="user_cpr" placeholder="الرقم الشخصي" required>
                                    <div id="error" style="width:50%;margin: auto;" style="margin:auto;display:none;">  <?php echo$error ?> </div>
                                        <div id="user_id_empty" > 
                                          <div class="alert alert-warning alert-dismissible" style="margin: auto;display:none;">
                                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                            <strong>Error !</strong> user_id Empty.
                                             </div>        
							...
							<input type="text" id="user_company" name="user_company" placeholder="اسم الشركة المرتبطة بالعميل" required>
                                <div id="user_company_empty" > 
                                          <div class="alert alert-warning alert-dismissible" style="margin: auto;display:none;">
                                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                            <strong>Error !</strong> company name Empty.
                                             </div>        
                        
                                                 </div>
                            
                            
                            <input type="number" id="user_rel_cpr" name="user_rel_cpr" placeholder="الرقم الشخصي لقريب " required>
                                <div id="user_share_empty" > 
                                          <div class="alert alert-warning alert-dismissible" style="margin: auto;display:none;">
                                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                            <strong>Error !</strong> username Empty.
                                             </div>        
                            ...
                            <input type="text" id="user_br" name="user_br" placeholder="رقم البنك المرجعي" required>
                                    <div id="user_br_empty" > 
                                          <div class="alert alert-warning alert-dismissible" style="margin: auto;display:none;">
                                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                            <strong>Error !</strong> username Empty.
                                             </div>        
							...
							<button id="submit_button" name="add_user"class="site-btn">إضافة العميل</button>
						</form>
 <script>

// var user_id_div  = document.getElementById('user_id_empty');
// var user_name_div  = document.getElementById('user_name_empty');
// var user_company_div  = document.getElementById('user_company_empty');
// var user_share_div  = document.getElementById('user_share_empty');
// var user_br_div  = document.getElementById('user_br_empty');

// user_id_div.style.display = 'none';
// user_name_div.style.display = 'none';
// user_company_div.style.display = 'none';
// user_share_div.style.display = 'none';
// user_br_div.style.display = 'none';
...
// $(document).ready(function(){
	...
	// $('#submit_button').click(function(){
        ...
        // var user_name = document.getElementById('user_company').value;
        // var user_name = document.getElementById('user_share').value;
        // var user_name = document.getElementById('user_br').value;


        
        // if( user_id.length == 0){
// user_id_div.style.display = 'block';
...
// // user_company_div.style.display = 'block';
// //         }
// //  else if(user_share == ""){
// // user_share_divdiv.style.display = 'block';

// //         }
// //  else if(user_company == ""){
// // user_br_div.style.display = 'block';
